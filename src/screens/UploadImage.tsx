...
export const UploadImage: React.FC<TestProps> = ( { navigation } ) => {
    ...
    return (
      <View style={styles.container}>
        <View>
        <Text style={{ color: "white", fontSize: 20, fontWeight: "bold", marginBottom: 10 }}>Image Uploaded</Text>
        ...
        <Text style={{ color: "white", fontSize: 16, marginBottom: 10, opacity: 0.5,textAlign:'center'}}> Or Customize</Text>
